...
**English** | [繁體中文](./README_TW.md) | [简体中文](./README.md)
...
🔗 **Demo URL: [http://223.6.255.214/](http://223.6.255.214/) [Mainland China]**
🔗 **Demo URL: [http://47.77.231.44/](http://47.77.231.44/) [International]**
...
<div align="center">
<img src="docs/images/generating.png" alt="PPT Generation Process" width="800"/>
...
<div align="center">
<img src="docs/images/result-table.png" alt="Table Data Embedding" width="800"/>
...
|---------|---------|---------|
| Google Gemini | Text/Image Generation | [Google AI Studio](https://makersuite.google.com/app/apikey) |
| iFlytek | Voice Transcription (Optional) | [iFlytek Platform](https://www.xfyun.cn/) |
...
- [x] Smart outline generation with iterative editing
- [x] AI design style generation
- [x] Gemini image generation page by page
- [x] Voice transcription to PPT
- [x] Custom colors, fonts, and logo
- [x] ZIP / PDF multi-format export
- [x] Material Upload - Support uploading PDF, Word, PPT, Excel, images, etc. AI auto-extracts and organizes
...
- [iFlytek](https://www.xfyun.cn/) - Speech-to-text service
